...
namespace EmployeeManagment.Data.Migrations
{
    ...
    [Migration("20210326114851_EmployeeLeaveTypeAddColumnIsActive")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeeManagment.Data.DbModels.EmployeeLeaveAllocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EmployeeManagment.Data.DbModels.EmployeeLeaveRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EmployeeManagment.Data.DbModels.EmployeeLeaveType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EmployeeManagment.Data.DbModels.Employee", b =>
                {
            ...
            modelBuilder.Entity("EmployeeManagment.Data.DbModels.EmployeeLeaveAllocation", b =>
                {
                    b.HasOne("EmployeeManagment.Data.DbModels.Employee", "Employee")
                        .WithMany()
                        .HasForeignKey("EmployeeId");

                    b.HasOne("EmployeeManagment.Data.DbModels.EmployeeLeaveType", "EmployeeLeaveType")
                        .WithMany()
            ...
            modelBuilder.Entity("EmployeeManagment.Data.DbModels.EmployeeLeaveRequest", b =>
                {
                    b.HasOne("EmployeeManagment.Data.DbModels.Employee", "ApprovedEmployee")
                        .WithMany()
                    ...
                    b.HasOne("EmployeeManagment.Data.DbModels.Employee", "RequestEmployee")
                        .WithMany()
